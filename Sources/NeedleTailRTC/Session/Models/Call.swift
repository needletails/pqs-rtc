...
public struct SDPNegotiationMetadata: Codable, Sendable, Equatable {
    ...
    public init(
        ...
        guard !answerDeviceId.trimmingCharacters(in: CharacterSet.whitespacesAndNewlines).isEmpty else {
            throw CallError.invalidMetadata("answerDeviceId cannot be empty")
        }
...
public struct StartCallMetadata: Codable, Sendable, Equatable {
    ...
    public init(
        ...
        // Validate input parameters for production safety
        guard !communicationId.trimmingCharacters(in: CharacterSet.whitespacesAndNewlines).isEmpty else {
        ...
        self.communicationId = communicationId.trimmingCharacters(in: CharacterSet.whitespacesAndNewlines)
